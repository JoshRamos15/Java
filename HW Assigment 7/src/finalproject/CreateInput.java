...
public class CreateInput {
	...
	static void createInputFile(){
		java.io.File file = new java.io.File("C:\\Users\\yourUserName\\eclipse-workspace\\YourProject\\src\\finalproject\\input.txt");
		...
		String [][] items = {
								{"CocoPuffs", "Edible"},{"FrostedFlakes", "Edible"},{"Pop corn", "Edible"},{ "Chicken", "edibleFresh"}, {"Coffee", "edible"}, {"Ham","edibleFresh"}, {"Cleaner", "notEdible"}, {"Diapers", "notEdible"}, 
								...
								{"Glass", "notEdible"},{"Gloves", "notEdible"}, {"Hat", "notEdible"}, {"Newspaper", "notEdible"}
							};
			
		//array of countries
		String [] contries = {"Spain","Russia","USA", "Canada", "UK", "China", "Japan", "Colombia", "Peru", "Brasil"};
